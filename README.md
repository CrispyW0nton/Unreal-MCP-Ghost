...
- Provide an editor-side chat panel with live level, actor, dirty-asset, compile, and SSE server context chips plus an optional Cursor SDK watcher for automatic replies.
