...
def register_savegame_tools(mcp: FastMCP):
    ...
    def create_savegame_blueprint(
        ...
        Example:
            create_savegame_blueprint(name="ExampleName")"""
    ...
    def add_save_game_to_slot_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_save_game_to_slot_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_load_game_from_slot_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_load_game_from_slot_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_does_save_game_exist_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_does_save_game_exist_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_create_save_game_object_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_create_save_game_object_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_delete_save_game_in_slot_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_delete_save_game_in_slot_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_set_game_paused_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_set_game_paused_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_quit_game_node(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_quit_game_node(blueprint_name="/Game/MCP_Test/BP_Example")"""
    ...
    def add_player_death_event(
        ...
        KB: see knowledge_base/17_GAME_SYSTEMS_COOKBOOK.md#overview
        Example:
            add_player_death_event(blueprint_name="/Game/MCP_Test/BP_Example")"""
